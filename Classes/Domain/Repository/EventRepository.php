...
class EventRepository extends \TYPO3\CMS\Extbase\Persistence\Repository
{
     ...
     */
    public function findAl_l($withRecurrence = true, $maxResults = 20)
    {
        ...
        //ggerUtility::var_dump($eventsArray);
        ...
        $mappingConfiguration
            ...
            ;
        $exceptionEventGroupMappingConfiguration = $mappingConfiguration->getConfigurationFor('exceptionEventGroups');
